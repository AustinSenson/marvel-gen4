 ...
 *******************************************************************************
*/
void printWriteConfig(uint8_t tIC, cell_asic *IC, TYPE_ADBMS6832 type, GRP grp)
{
 ...
 *******************************************************************************
*/
void printReadConfig(uint8_t tIC, cell_asic *IC, TYPE_ADBMS6832 type, GRP grp)
{
  for(uint8_t ic = 0; ic < tIC; ic++)
  {
    pc.printf("IC%d:\n",(ic+1));
 ...
 *******************************************************************************
*/
void printVoltages(uint8_t tIC, cell_asic *IC, TYPE_ADBMS6832 type)
{
  float voltage;
  int16_t temp;
  uint8_t channel;
 ...
 *******************************************************************************
*/
void printStatus(uint8_t tIC, cell_asic *IC, TYPE_ADBMS6832 type, GRP grp)
{
  float voltage;
  for(uint8_t ic = 0; ic < tIC; ic++)
  {
 ...
 *******************************************************************************
*/
void printDeviceSID(uint8_t tIC, cell_asic *IC, TYPE_ADBMS6832 type)
{
  for(uint8_t ic = 0; ic < tIC; ic++)
  {
    pc.printf("IC%d:\n",(ic+1));
...
*******************************************************************************
*/
void printWritePwmDutyCycle(uint8_t tIC, cell_asic *IC, TYPE_ADBMS6832 type, GRP grp)
{
  for(uint8_t ic = 0; ic < tIC; ic++)
  {
    pc.printf("IC%d:\n",(ic+1));
...
*******************************************************************************
*/
void printReadPwmDutyCycle(uint8_t tIC, cell_asic *IC, TYPE_ADBMS6832 type, GRP grp)
{
  for(uint8_t ic = 0; ic < tIC; ic++)
  {
    pc.printf("IC%d:\n",(ic+1));
...
* @brief Print Write Comm_6832 data.
*
...
*******************************************************************************
*/
void printWriteCommData(uint8_t tIC, cell_asic *IC, TYPE_ADBMS6832 type)
{
  for(uint8_t ic = 0; ic < tIC; ic++)
  {
    pc.printf("IC%d:\n",(ic+1));
    if(type == Comm_6832)
    {
      pc.printf("Write Comm_6832 Data:\n");
...
* @brief Print Read Comm_6832 Data.
*
...
*******************************************************************************
*/
void printReadCommData(uint8_t tIC, cell_asic *IC, TYPE_ADBMS6832 type)
{
  for(uint8_t ic = 0; ic < tIC; ic++)
  {
    pc.printf("IC%d:\n",(ic+1));
...
*******************************************************************************
*/
void printOpenWireTestResult(uint8_t tIC, cell_asic *IC, TYPE_ADBMS6832 type)
{
  if(type == Cell)
  {
...
void printMenu()
{
  ...
  pc.printf("Read Status_6832 Registers: 15            \n");
...
void printMenu()
{
  ...
  printf("Read Status_6832 Registers: 15 \n");
