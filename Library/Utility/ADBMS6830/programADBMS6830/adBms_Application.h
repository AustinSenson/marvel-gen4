...
void adBms6830_cell_ow_volatge_collect(uint8_t tIC, cell_asic *ic, TYPE_ADBMS6832 type, OW_C_S ow_c_s);
...
void adBms6830_open_wire_detection_condtion_check(uint8_t tIC, cell_asic *ic, TYPE_ADBMS6832 type);
