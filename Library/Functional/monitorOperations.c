...
bmsStatus_t sendDataOnCAN(bmsMainData_t *mdata, protectionOutput_t *pOutput, coulombCountingOutput_t *ccOutput)
{
	...
	// 	canDataFrame[CAN_bmsState.messageStartByte + canDLC] = ((int) (mdata->bmsState/CAN_bmsState.messageScaling)  >> (8 * canDLC));
	...
	//delayMilliSeconds(CAN_MESSAGE_DELAY);
		...
		for(int8_t canDLC = CAN_cmu2Cell1.messageDLC - 1; canDLC >= 0; canDLC--)
			canDataFrame[CAN_cmu2Cell1.messageStartByte + canDLC] = ((int) (mdata->cmuData.cmuVolatges.cellVoltages[1][12]/CAN_cmu2Cell1.messageScaling)  >> (8 * canDLC));
		
		for(int8_t canDLC = CAN_cmu2Cell2.messageDLC - 1; canDLC >= 0; canDLC--)
			canDataFrame[CAN_cmu2Cell2.messageStartByte + canDLC] = ((int) (mdata->cmuData.cmuVolatges.cellVoltages[1][13]/CAN_cmu2Cell2.messageScaling)  >> (8 * canDLC));
		
		for(int8_t canDLC = CAN_cmu2Cell3.messageDLC - 1; canDLC >= 0; canDLC--)
			canDataFrame[CAN_cmu2Cell3.messageStartByte + canDLC] = ((int) (mdata->cmuData.cmuVolatges.cellVoltages[1][14]/CAN_cmu2Cell3.messageScaling)  >> (8 * canDLC));
		
		for(int8_t canDLC = CAN_cmu2Cell4.messageDLC - 1; canDLC >= 0; canDLC--)
			canDataFrame[CAN_cmu2Cell4.messageStartByte + canDLC] = ((int) (mdata->cmuData.cmuVolatges.cellVoltages[1][15]/CAN_cmu2Cell4.messageScaling)  >> (8 * canDLC));
	...
	//delayMilliSeconds(CAN_MESSAGE_DELAY);
		...
		for(int8_t canDLC = CAN_cmu2Cell5.messageDLC - 1; canDLC >= 0; canDLC--)
			canDataFrame[CAN_cmu2Cell5.messageStartByte + canDLC] = ((int) (mdata->cmuData.cmuVolatges.cellVoltages[1][16]/CAN_cmu2Cell5.messageScaling)  >> (8 * canDLC));
		
		for(int8_t canDLC = CAN_cmu2Cell6.messageDLC - 1; canDLC >= 0; canDLC--)
			canDataFrame[CAN_cmu2Cell6.messageStartByte + canDLC] = ((int) (mdata->cmuData.cmuVolatges.cellVoltages[1][17]/CAN_cmu2Cell6.messageScaling)  >> (8 * canDLC));
