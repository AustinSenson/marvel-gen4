...
CANdataStd       CAN_ccOut_cycleCount;
...
CANdataStd       CAN_MCUTEMP1;  
CANdataStd       CAN_MCUTEMP2;
CANdataStd       CAN_MCUTEMP3;
CANdataStd       CAN_MCUTEMP4;
...
CANdataStd       CAN_cmu1Cell13;
CANdataStd       CAN_cmu1Cell14;
CANdataStd       CAN_cmu1Cell15;
CANdataStd       CAN_cmu1Cell16;
CANdataStd       CAN_cmu1Cell17;
CANdataStd       CAN_cmu1Cell18;
...
CANdataStd       CAN_cmu2Cell13;
CANdataStd       CAN_cmu2Cell14;
CANdataStd       CAN_cmu2Cell15;
CANdataStd       CAN_cmu2Cell16;
CANdataStd       CAN_cmu2Cell17;
CANdataStd       CAN_cmu2Cell18;
...
CANdataStd       CAN_cmu3Cell13;
CANdataStd       CAN_cmu3Cell14;
CANdataStd       CAN_cmu3Cell15;
CANdataStd       CAN_cmu3Cell16;
CANdataStd       CAN_cmu3Cell17;
CANdataStd       CAN_cmu3Cell18;
...
CANdataStd       CAN_ccOut_PackEnergy;
...
CANdataStd      CAN_pIn_calculatedi2tFuseValue;
CANdataStd      CAN_pOut_activeErrors;
CANdataStd      CAN_pOut_overCurrentProtection;
...
void initializeDebugCANMatrix(void)
{
    ...
    CAN_pIn_calculatedi2tFuseValue.messageID                      = CAN_DEBUG_ID_032;
    CAN_pIn_calculatedi2tFuseValue.messageDLC                     = 4;
    CAN_pIn_calculatedi2tFuseValue.messageStartByte               = 0;
    CAN_pIn_calculatedi2tFuseValue.messageScaling                 = 1;
    ...
    //protection In - ID 17
    // CAN_pIn_voltageMax.messageID                     = CAN_TX_ID_024;
    ...
    // CAN_pIn_voltageMin.messageID                     = CAN_TX_ID_024;
    ...
    // CAN_pIn_voltageDelta.messageID                     = CAN_TX_ID_024;
    ...
    CAN_pOut_activeErrors.messageID                = CAN_TX_ID_025;
    CAN_pOut_activeErrors.messageDLC               = 8;
    CAN_pOut_activeErrors.messageStartByte         = 0;
    CAN_pOut_activeErrors.messageScaling           = 1;


    //using 0x323 ID for publishing pack energy as OCC and OCD are not being used
    CAN_ccOut_PackEnergy.messageID                = CAN_DEBUG_ID_004;
    CAN_ccOut_PackEnergy.messageDLC               = 4;
    CAN_ccOut_PackEnergy.messageStartByte         = 0;
    CAN_ccOut_PackEnergy.messageScaling           = 1;

    // CAN_ccOut_cycleCount.messageID                = CAN_DEBUG_ID_032;
    // CAN_ccOut_cycleCount.messageDLC               = 2;
    // CAN_ccOut_cycleCount.messageStartByte         = 4;
    // CAN_ccOut_cycleCount.messageScaling           = 1;
    ...
    //cc EKF 29
    CAN_pOut_overCurrentProtection.messageID          = CAN_DEBUG_ID_029;
    CAN_pOut_overCurrentProtection.messageDLC         = 1;
    CAN_pOut_overCurrentProtection.messageStartByte   = 0;
    CAN_pOut_overCurrentProtection.messageScaling     = 1;

    CAN_pOut_overCurrentProtection.messageID          = CAN_DEBUG_ID_029;
    CAN_pOut_overCurrentProtection.messageDLC         = 1;
    CAN_pOut_overCurrentProtection.messageStartByte   = 1;
    CAN_pOut_overCurrentProtection.messageScaling     = 1;
...
bmsStatus_t initializeCANMatrix(uint8_t canPort)
{
    ...
    if(canPort == communicationCAN)
    {
        ...
        CAN_MCUTEMP1.messageID                      = CAN_TX_ID_003;            //MCU temp1
        CAN_MCUTEMP1.messageDLC                     = 1;
        CAN_MCUTEMP1.messageStartByte               = 0;
        CAN_MCUTEMP1.messageScaling                 = CMU_TEMP_MESSAGE_SCALING;

        CAN_MCUTEMP2.messageID                      = CAN_TX_ID_003;            //MCU temp2 
        CAN_MCUTEMP2.messageDLC                     = 1;
        CAN_MCUTEMP2.messageStartByte               = 1;
        CAN_MCUTEMP2.messageScaling                 = CMU_TEMP_MESSAGE_SCALING;

        CAN_MCUTEMP3.messageID                      = CAN_TX_ID_003;            //MCU temp3
        CAN_MCUTEMP3.messageDLC                     = 1;
        CAN_MCUTEMP3.messageStartByte               = 2;
        CAN_MCUTEMP3.messageScaling                 = CMU_TEMP_MESSAGE_SCALING;

        CAN_MCUTEMP4.messageID                      = CAN_TX_ID_003;            //MCU temp4
        CAN_MCUTEMP4.messageDLC                     = 1;
        CAN_MCUTEMP4.messageStartByte               = 3;
        CAN_MCUTEMP4.messageScaling                 = CMU_TEMP_MESSAGE_SCALING;

        CAN_cmu1Temp1.messageID                      = CAN_TX_ID_003;            //CMU temp1
        CAN_cmu1Temp1.messageDLC                     = 1;
        CAN_cmu1Temp1.messageStartByte               = 4;
        CAN_cmu1Temp1.messageScaling                 = CMU_TEMP_MESSAGE_SCALING;

        CAN_cmu1Temp2.messageID                      = CAN_TX_ID_003;            //CMU temp2
        CAN_cmu1Temp2.messageDLC                     = 1;
        CAN_cmu1Temp2.messageStartByte               = 5;
        ...
        CAN_packCapacity.messageScaling             = 0.01;

        CAN_cmu1Temp3.messageID                      = CAN_TX_ID_004;
        CAN_cmu1Temp3.messageDLC                     = 1;
        CAN_cmu1Temp3.messageStartByte               = 0;
        CAN_cmu1Temp3.messageScaling                 = CMU_TEMP_MESSAGE_SCALING;

        CAN_cmu1Temp4.messageID                      = CAN_TX_ID_004;
        CAN_cmu1Temp4.messageDLC                     = 1;
        CAN_cmu1Temp4.messageStartByte               = 1;
        ...
        CAN_cmu1Cell13.messageID                     = CAN_TX_ID_008;
        CAN_cmu1Cell13.messageDLC                    = 2;
        CAN_cmu1Cell13.messageStartByte              = 0;
        CAN_cmu1Cell13.messageScaling                = CMU_CELL_VOLTAGE_MESSAGE_SCALING;

        CAN_cmu1Cell14.messageID                     = CAN_TX_ID_008;
        CAN_cmu1Cell14.messageDLC                    = 2;
        CAN_cmu1Cell14.messageStartByte              = 2;
        CAN_cmu1Cell14.messageScaling                = CMU_CELL_VOLTAGE_MESSAGE_SCALING;

        CAN_cmu1Cell15.messageID                     = CAN_TX_ID_008;
        CAN_cmu1Cell15.messageDLC                    = 2;
        CAN_cmu1Cell15.messageStartByte              = 4;
        CAN_cmu1Cell15.messageScaling                = CMU_CELL_VOLTAGE_MESSAGE_SCALING;

        CAN_cmu1Cell16.messageID                     = CAN_TX_ID_008;
        CAN_cmu1Cell16.messageDLC                    = 2;
        CAN_cmu1Cell16.messageStartByte              = 6;
        CAN_cmu1Cell16.messageScaling                = CMU_CELL_VOLTAGE_MESSAGE_SCALING;

        CAN_cmu2Cell1.messageID                     = CAN_TX_ID_009;
        CAN_cmu2Cell1.messageDLC                    = 2;
        CAN_cmu2Cell1.messageStartByte              = 0;
        CAN_cmu2Cell1.messageScaling                = CMU_CELL_VOLTAGE_MESSAGE_SCALING;

        CAN_cmu2Cell2.messageID                     = CAN_TX_ID_009;
        CAN_cmu2Cell2.messageDLC                    = 2;
        CAN_cmu2Cell2.messageStartByte              = 2;
        CAN_cmu2Cell2.messageScaling                = CMU_CELL_VOLTAGE_MESSAGE_SCALING;

        CAN_cmu2Cell3.messageID                     = CAN_TX_ID_009;
        CAN_cmu2Cell3.messageDLC                    = 2;
        CAN_cmu2Cell3.messageStartByte              = 4;
        CAN_cmu2Cell3.messageScaling                = CMU_CELL_VOLTAGE_MESSAGE_SCALING;

        CAN_cmu2Cell4.messageID                     = CAN_TX_ID_009;
        CAN_cmu2Cell4.messageDLC                    = 2;
        CAN_cmu2Cell4.messageStartByte              = 6;
        CAN_cmu2Cell4.messageScaling                = CMU_CELL_VOLTAGE_MESSAGE_SCALING;

        CAN_cmu2Cell5.messageID                     = CAN_TX_ID_010;
        CAN_cmu2Cell5.messageDLC                    = 2;
        CAN_cmu2Cell5.messageStartByte              = 0;
        CAN_cmu2Cell5.messageScaling                = CMU_CELL_VOLTAGE_MESSAGE_SCALING;

        CAN_cmu2Cell6.messageID                     = CAN_TX_ID_010;
        CAN_cmu2Cell6.messageDLC                    = 2;
        CAN_cmu2Cell6.messageStartByte              = 2;
        CAN_cmu2Cell6.messageScaling                = CMU_CELL_VOLTAGE_MESSAGE_SCALING;

        CAN_cmu2Cell7.messageID                     = CAN_TX_ID_010;
        CAN_cmu2Cell7.messageDLC                    = 2;
        CAN_cmu2Cell7.messageStartByte              = 4;
        CAN_cmu2Cell7.messageScaling                = CMU_CELL_VOLTAGE_MESSAGE_SCALING;

        CAN_cmu2Cell8.messageID                     = CAN_TX_ID_010;
        ...
        CAN_cmu2Cell11.messageID                     = CAN_TX_ID_016;
        ...
        CAN_cmu2Cell12.messageID                     = CAN_TX_ID_016;
        ...
        CAN_cmu2Cell13.messageID                     = CAN_TX_ID_017;
        CAN_cmu2Cell13.messageDLC                    = 2;
        CAN_cmu2Cell13.messageStartByte              = 0;
        CAN_cmu2Cell13.messageScaling                = CMU_CELL_VOLTAGE_MESSAGE_SCALING;

        CAN_cmu2Cell14.messageID                     = CAN_TX_ID_017;
        CAN_cmu2Cell14.messageDLC                    = 2;
        CAN_cmu2Cell14.messageStartByte              = 2;
        CAN_cmu2Cell14.messageScaling                = CMU_CELL_VOLTAGE_MESSAGE_SCALING;

        CAN_cmu2Cell15.messageID                     = CAN_TX_ID_017;
        CAN_cmu2Cell15.messageDLC                    = 2;
        CAN_cmu2Cell15.messageStartByte              = 4;
        CAN_cmu2Cell15.messageScaling                = CMU_CELL_VOLTAGE_MESSAGE_SCALING;

        CAN_cmu2Cell16.messageID                     = CAN_TX_ID_017;
        CAN_cmu2Cell16.messageDLC                    = 2;
        CAN_cmu2Cell16.messageStartByte              = 6;
        CAN_cmu2Cell16.messageScaling                = CMU_CELL_VOLTAGE_MESSAGE_SCALING;
        ...
        CAN_ccOut_cycleCount.messageID                = CAN_TX_ID_022;
        CAN_ccOut_cycleCount.messageDLC               = 2;
        CAN_ccOut_cycleCount.messageStartByte         = 6;
        CAN_ccOut_cycleCount.messageScaling           = 1;
        ...
        CAN_cIn_contactorCommand.messageID                = CAN_TX_ID_024;
        CAN_cIn_contactorCommand.messageDLC               = 1;
        CAN_cIn_contactorCommand.messageStartByte         = 6;
        CAN_cIn_contactorCommand.messageScaling           = 1;
