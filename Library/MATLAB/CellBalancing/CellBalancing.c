...
static void CellBalancing_CellBalance(void)
{
  ...
  if (CellBalancing_B.BalanceEn) {
    ...
    if (CellBalancing_U.DataPipeline.VoltageSenseBus.Voltages_mV[(int32_T)
      ...
      /* Outport: '<Root>/BalanceCmd' */
      /* :  BalanceCmd(i)=1; */
      CellBalancing_Y.BalanceCmd[(int32_T)CellBalancing_DW.i - 1] = 1;

      /* :  BalanceFetCmd(i,1) */
    } else {
      /* Outport: '<Root>/BalanceCmd' */
      /* :  BalanceCmd(i)=0; */
      CellBalancing_Y.BalanceCmd[(int32_T)CellBalancing_DW.i - 1] = 0;
