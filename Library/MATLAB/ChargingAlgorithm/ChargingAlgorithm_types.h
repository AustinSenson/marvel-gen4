...
#ifndef RTW_HEADER_ChargingAlgorithm_types_h_
#define RTW_HEADER_ChargingAlgorithm_types_h_
#include "rtwtypes.h"
...
#ifndef DEFINED_TYPEDEF_FOR_ChargeState_
#define DEFINED_TYPEDEF_FOR_ChargeState_

typedef enum {
  NoCharging = 0,                      /* Default value */
  SlowCharging,
  FastCharging,
  PseudoCharging,
  IR_Measurement
...
typedef struct tag_RTM_ChargingAlgorithm_T RT_MODEL_ChargingAlgorithm_T;

#endif                               /* RTW_HEADER_ChargingAlgorithm_types_h_ */
