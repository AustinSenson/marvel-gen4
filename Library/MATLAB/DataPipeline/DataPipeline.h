...
typedef struct {
  int32_T Selector_DIMS1;              /* '<S4>/Selector' */
...
typedef struct {
  ...
  int32_T VoltageSense_mV[20];         /* '<Root>/VoltageSense_mV' */
 ...
 *
 * hilite_system('BMS_Algo_Release_v10_16_9/DataPipeline')    - opens subsystem BMS_Algo_Release_v10_16_9/DataPipeline
 * hilite_system('BMS_Algo_Release_v10_16_9/DataPipeline/Kp') - opens and selects block Kp
 *
 * Here is the system hierarchy for this model
 *
 * '<Root>' : 'BMS_Algo_Release_v10_16_9'
 * '<S1>'   : 'BMS_Algo_Release_v10_16_9/DataPipeline'
 * '<S2>'   : 'BMS_Algo_Release_v10_16_9/DataPipeline/AverageFunction'
 * '<S3>'   : 'BMS_Algo_Release_v10_16_9/DataPipeline/DynamicCurrentLimits_perParallelCell'
 * '<S4>'   : 'BMS_Algo_Release_v10_16_9/DataPipeline/GetN3'
 * '<S5>'   : 'BMS_Algo_Release_v10_16_9/DataPipeline/I2t_perParallelCell'
 * '<S6>'   : 'BMS_Algo_Release_v10_16_9/DataPipeline/MaximumFunction'
 * '<S7>'   : 'BMS_Algo_Release_v10_16_9/DataPipeline/MinimumFunction'
 */
